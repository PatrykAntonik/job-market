...
#         name="City1", country=country, province="Province1", zip_code="12345"
#     )
#     city2 = City.objects.create(
#         name="City2", country=country, province="Province1", zip_code="12345"
#     )
#     expected_data = [
#         {
#             "country": country.id,
...
#     client = APIClient()
#     response = client.get(
#         f"/api/industry/{non_existent_id}/", HTTP_ACCEPT="application/json"
#     )
#     assert (
...
#             "company_name": "Test Employer",
#             "website_url": "www.test.com",
#             "industry": {"id": industry.id, "name": "Test Industry"},
#             "description": "Test employer",
#             "benefits": [],
#         },
#         {
...
#     )
#     city2 = City.objects.create(
#         name="Test City2", country=country, province="Test Province", zip_code="12345"
#     )
#     user = User.objects.create_user(
#         email="test@gmail.com",
#         password="<PASSWORD>",
